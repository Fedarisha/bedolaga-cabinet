        ...
        {deepLinkToken && deepLinkUrl ? (
          <>
            ...
            <a
              ...
              className="inline-flex min-h-[54px] w-full max-w-xs items-center justify-center gap-3 rounded-xl bg-[#2AABEE] px-6 py-3 text-base font-semibold text-white shadow-lg shadow-[#2AABEE]/25 transition-colors hover:bg-[#229ED9]"
            >
