      ...
      return (
        <svg className={className} viewBox="0 0 24 24" aria-hidden="true">
          ...
          <g transform="translate(1.55 0)">
            <path
              d="M13.85 18.8h-2.02v-5.62h-.73L8.6 18.8H6.4l2.77-6.08a4.16 4.16 0 0 1-1.66-1.4 3.63 3.63 0 0 1-.57-2.05c0-1.3.43-2.3 1.29-3.01.86-.7 2.07-1.06 3.62-1.06h2V18.8Zm-2.02-7.25V6.9h-.33c-.82 0-1.44.2-1.86.6-.42.39-.63.97-.63 1.72 0 .72.2 1.28.61 1.7.41.42 1 .63 1.78.63h.43Z"
              fill="white"
            />
          </g>
        </svg>
